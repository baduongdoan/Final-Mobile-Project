    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnSignIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                progressDialog.show();
                auth.signInWithEmailAndPassword(binding.etEmail2.getText().toString(), binding.etPassword2.getText().toString()).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    @Override
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                          ...
                          //  updateUI(user);
                            ...
                            Toast.makeText(SignInActivity.this, task.getException().getMessage(),Toast.LENGTH_SHORT);
                            Snackbar.make(binding.getRoot(),"Authentication Failure",Snackbar.LENGTH_SHORT);
                           // updateUI(null);
                        }
                    }
                });
